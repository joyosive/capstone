        ...
        <v-container class="mx-12">
            ...
            >
                <template v-slot:item.View="{ item }">
                    <v-btn class="blue" dark small v-model="item.View" text>View</v-btn>
                </template>
            ...
            <v-dialog v-model="dialog" max-width="290">
                <v-card>
                    <v-toolbar-title class="blue lighten-3 pa-4">Want to withdraw this bid?</v-toolbar-title>

                    <v-text-field outlined single-line class="ma-8" label="Please specify reason "></v-text-field>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn color="green darken-1" text @click="dialog = false">Withdraw</v-btn>
                    </v-card-actions>
                </v-card>
            </v-dialog>
        </v-container>
