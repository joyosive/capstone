        ...
        <v-row>
            <v-col cols="12">
                <v-row align="start" justify="center" class="grey lighten-5" style="height: 100px;">
                    <v-card class="ma-3 pa-6" outlined tile>120 New Bids</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>25 Complaints</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>4 New Tenders</v-card>
                    <v-card class="ma-3 pa-6" outlined tile>175 Total Tenders</v-card>
                </v-row>
            </v-col>
        </v-row>
